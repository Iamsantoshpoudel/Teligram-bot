...
const demoMessages = [
  {
    id: 1,
    text: "Hey there! I'm Santosh Poudel, the developer of PoudelX chat app. 👋",
    isUser: false,
  },
  {
    id: 2,
    text: "Oh wow, so you created this app? That’s awesome!",
    isUser: true,
  },
  {
    id: 3,
    text: "Yep! With PoudelX, you can chat with your friends securely and privately.",
    isUser: false,
  },
  { id: 4, text: "Nice! Privacy is super important these days.", isUser: true },
  {
    id: 5,
    text: "Exactly! That’s why PoudelX doesn’t even require only email to sign up.",
    isUser: false,
  },
  { id: 6, text: "Wait, really? So it’s completely anonymous?", isUser: true },
  {
    id: 7,
    text: "Yes! Your data stays on your device, and messages are end-to-end encrypted.",
    isUser: false,
  },
  {
    id: 8,
    text: "That’s amazing! No worries about data leaks then.",
    isUser: true,
  },
  {
    id: 9,
    text: "Exactly! Thousands of users already trust PoudelX for private messaging.",
    isUser: false,
  },
  {
    id: 10,
    text: "Sounds like the future of secure chatting! 🚀",
    isUser: true,
  },
];
